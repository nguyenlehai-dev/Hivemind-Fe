...
import AppsOverviewContent from "../apps/AppsOverviewContent";
...
export default function RunwayCustomPage() {
  ...
  return (
    <AppShell
      headerVariant={activeView === "home" ? "overlay" : "light"}
      className={
        activeView === "home"
          ? "estate-page"
          : activeView === "custom" || activeView === "overview"
            ? "custom-page"
            : "jobs-page"
      }
      navItems={navItems}
      onOpenWorkflow={() => setActiveView("custom")}
    >
      {activeView === "home" && (
              ...
              <div className="estate-hero__content">
                ...
                <div className="estate-search-panel estate-glass-card">
                  <div className="estate-search-field">
                    <label>Mode</label>
                    <TextInput type="text" value="Image" readOnly />
                  </div>
                ...
                <div className="estate-tour-panel estate-glass-card">
                  ...
                  <div className="estate-tour-panel__stage">
                    ...
                    <div className="estate-tour-panel__overlay-card">
                      <span>Provider tabs Â· filtered list</span>
              ...
              <form className="estate-contact-card estate-glass-card">
                ...
                <div className="estate-contact-form__row">
                  <div className="estate-form-field">
                    ...
                    <TextInput type="text" placeholder="Model picker modal" />
                  </div>
                  <div className="estate-form-field">
                    <label>Initial mode</label>
                    <TextInput type="text" placeholder="Image generation" />
                  </div>
                </div>
                <div className="estate-form-field">
                  <label>Provider groups</label>
                  <TextInput type="text" placeholder="Google, Runway, BFL, OpenAI..." />
                </div>
                <div className="estate-form-field">
                  <label>Selection outcome</label>
                  <TextInput type="text" placeholder="Sync selected model back to composer" />
                </div>
                <div className="estate-form-field">
                  <label>Notes</label>
                  <textarea
      ...
      {activeView === "overview" && (
        <AppsOverviewContent onOpenPreset={() => setActiveView("custom")} />
      )}
      {activeView === "custom" && <CustomWorkflowContent />}
